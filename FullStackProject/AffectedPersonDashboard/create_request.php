            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item"><a class="nav-link" href="http://localhost/FullStackProject/AffectedPersonDashboard/dashboard.php">Dashboard</a></li>
                        <li class="nav-item"><a class="nav-link active" href="http://localhost/FullStackProject/AffectedPersonDashboard/create_request.php">Create Request</a>
                        </li>
                        <li class="nav-item"><a class="nav-link" href="http://localhost/FullStackProject/AffectedPersonDashboard/view_requests.php">My Requests</a></li>
                        ...
                        <div class="card-body p-4 p-md-5">
                            <form id="reliefRequestForm" action="submit_request.php" method="POST">
                                ...
                                <div class="d-grid gap-2 d-md-flex justify-content-md-end mt-5">
                                    <a href="http://localhost/FullStackProject/AffectedPersonDashboard/view_requests.php" 
                                        class="btn btn-outline-secondary btn-lg">
                                        <i class="bi bi-x-circle me-2"></i>Cancel
                                    </a>
                                    <a href="http://localhost/FullStackProject/AffectedPersonDashboard/create_request.php" 
                                        class="btn btn-outline-secondary btn-lg">
