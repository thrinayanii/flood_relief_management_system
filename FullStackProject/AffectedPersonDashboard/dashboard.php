        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand fw-bold text-primary"
                    href="http://localhost/FullStackProject/AffectedPersonDashboard/dashboard.php">
                    ...
                    <ul class="navbar-nav ms-auto">
                        <li class="nav-item">
                            <a class="nav-link active"
                                href="http://localhost/FullStackProject/AffectedPersonDashboard/dashboard.php">Dashboard</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="http://localhost/FullStackProject/AffectedPersonDashboard/create_request.php">Create
                                Request</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link"
                                href="http://localhost/FullStackProject/AffectedPersonDashboard/view_requests.php">My
                                Requests</a>
                        </li>
                        <li class="nav-item">
