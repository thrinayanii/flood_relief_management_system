<?php
    session_start();
    include 'reterivedata_cards.php';
 ?>
                    ...
                    <div class="card-body">
                        ...
                        <div class="border-top pt-3">
                            <div class="btn-group w-100" role="group">
                                <button type="button" class="btn btn-outline-primary viewBtn"
                                    data-id="<?php echo $row['ReliefID']; ?>"
                                    data-name="<?php echo $row['ContactPersonName']; ?>"
                                    data-type="<?php echo $row['TypeofRelief']; ?>"
                                    data-severity="<?php echo $row['FloodSeverityLevel']; ?>"
                                    data-status="<?php echo $row['Status']; ?>"
                                    data-date="<?php echo $row['date']; ?>"
                                    data-contact="<?php echo $row['ContactPersonNumber']; ?>"
                                    data-family="<?php echo $row['NoOfFamilyMembers']; ?>"
                                    data-address="<?php echo $row['District']; ?>"
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                            <h5 class="modal-title">Relief Details</h5>
                            <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                            <p><strong>Relief ID:</strong> <span id="ReliefID"></span></p>
                            ...
                            <p><strong>Family Members:</strong> <span id="Family"></span></p>
