...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 03, 2026 at 03:31 PM
...
(1, 1, 'Food', 'Colombo', 'Colombo 03', 'Borella', 'Nimal Perera', '0712345678', '123 Main St, Colombo', 4, 'High', 'Family needs urgent food supplies', 'Approved', '2026-03-19'),
...
(4, 3, 'Shelter', 'Galle', 'Hikkaduwa', 'Galle Town', 'Rohana Jayawardena', '0771122334', '22 Beach Rd, Galle', 6, 'High', 'Temporary shelter required after flood', 'Pending', '2026-03-16'),
...
(11, 3, 'Water', 'Colombo', 'Colombo North', 'Kotahena West', 'Rohit Perera', '0701234567', '123, Main Street, Kotahena, Colombo 01300', 5, 'Low', 'Our household is affected by low-level flooding. We require clean drinking water as soon as possible.\r\nSpecial requirements: One family member has diabetes and requires sugar-free foods. We also have an elderly member who requires daily medication. Urgent', 'Pending', '2026-04-03');
...
(3, 4, 'D.R. Wijenayake', '0718125924', '2026-03-10'),
(4, 5, 'Mohanaruby S', '0741825226', '2026-03-19');
...
--
ALTER TABLE `reliefdetails`
  MODIFY `ReliefID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
